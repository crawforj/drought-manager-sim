...
|---|---:|---:|
| Price-elasticity DiD: tier1 step (% of weather-expected demand) | -10.2% | -14.4% |
| Price-elasticity DiD: tier2/3 step (% of weather-expected demand) | -9.7% | -15.4% |
| DiD effect sign / significance | negative, p=0.033 (significant) | negative, p=0.0000 (significant) |
| Segmentation: top-consumers volume share | 1.0% of accounts → 25.5% of volume | 1.0% → 24.6% |
...
| NRW correlation, system B (WTP production input) | 0.939 | 0.914 |
| Demand forecast series: mean (MGD) | 10.7 | 4.3 |
| Demand forecast series: autocorrelation (lag 1 / 7 / 14) | 0.64 / 0.62 / 0.60 | 0.70 / 0.48 / 0.53 |
